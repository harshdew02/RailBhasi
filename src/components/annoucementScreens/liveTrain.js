    ...
    <SafeAreaView>
      ...
      >
        <TextInput
          ...
          value={number}
          placeholder={PREDEFINED_LANGUAGE["pgtn"][lang]}
      ...
      <View className="flex-row">
        <ScrollView
          className="border-2 border-black h-44 m-4"
          style={{ width: "70%" }}
        >
          <Text style={{padding:wp(3)}}>{liveText}</Text>
        </ScrollView>
      ...
      {trainSchedule && (
        <Green
          cardData={trainSchedule[0]}
          handleAnnouncement={handleAnnouncement}
        />
      )}
      <ScrollView>
        {trainSchedule &&
          trainSchedule.map((cardData, idx) => {
      ...
      {trainSchedule && (
        <Red
          cardData={trainSchedule[trainSchedule.length - 1]}
          handleAnnouncement={handleAnnouncement}
        />
      )}
    </SafeAreaView>
      ...
      >
        ...
        <View className="flex-col justify-between align-center">
          <Text className="text-[#16247d] text-[16px] font-medium">
            {cardData.stationName}
          </Text>
          <Text className="text-[14px] font-medium">{`(${cardData.stationCode})`}</Text>
          <Text>
            {PREDEFINED_LANGUAGE["PF"][lang]} : {cardData.platform}
          </Text>
        </View>
        <Text className="font-medium text-[16px]">
        ...
        <TouchableOpacity
          className="rounded-3xl p-2 bg-green-600"
