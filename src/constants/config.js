...
const PREDEFINED_ANNOUNCEMENT = [
  ...
  },
  {
    ...
    custom:
      "Train number (13287), the (3287), is currently delayed by (287) hour and (87) minutes. It is expected to arrive at (7) on platform number (6) at (18:00) with a (5) minutes scheduled halt.",
    custom_ontime:
      "Train number (13287), the (3287), is running on time. It is expected to arrive at (7) on platform number (6) at (18:00) with a (5) minutes scheduled halt.",
    word_arr: "Arrival",
    word_dep: "Departure",
    word_stop: "Stop",
    word_no: "Train no.",
  },
  {
    ...
    code: "as",
    custom:
      "ট্ৰেইন নম্বৰ (train_no), (দক্ষিণ বিহাৰ এক্সপ্ৰেছ), বৰ্তমান (30) মিনিট পলম হৈছে। ই প্লেটফৰ্ম নম্বৰ (1) ত (19:00) (15) মিনিটৰ নিৰ্ধাৰিত অৱস্থানৰ সৈতে (টাটানগৰ জংচন) ত উপস্থিত হ 'ব বুলি আশা কৰা হৈছে।",
  ...
  },
  {
    ...
    code: "bn",
    custom:
      "ট্রেন নম্বর (train_no), (দক্ষিণ বিহার এক্সপ্রেস), বর্তমানে (30) মিনিট বিলম্বিত হচ্ছে। এটি (15) মিনিটের নির্ধারিত বিরতি সহ (1) নম্বর প্ল্যাটফর্মে (19:00) (টাটানগর জংশন) পৌঁছবে বলে আশা করা হচ্ছে।",
...

  {
    ...
    code: "brx",
    custom:
      "'्रेन नम्बर (train_no), (खोला बिहार एक्सप्रेस) आ आथिखालाव (30) मिनिट गोबाव जादों। बेखौ प्लेटफर्म नम्बर (1) आव (19:00) (15) मिनिटनि थि थाद 'नायजों (टाटानगर जंक्शन) सौफैनायनि आसा दं।'",
  ...
  },
  {
    ...
    code: "doi",
    custom:
      "ट्रेन नंबर (train_no), (दक्खन बिहार एक्सप्रेस), वर्तमान च (30) मिंटें दी देरी कन्नै चलदी ऐ। एह्दे प्लेटफार्म नंबर (1) पर (19:00) (15) मिंटें दे निर्धारित विराम दे कन्नै (टाटानगर जंक्शन) औने दी मेद ऐ।",
  ...
  },
  {
    ...
    code: "gom",
    custom:
      "ट्रेन क्रमांक (train_no), (दक्षिण बिहार एक्सप्रेस), सद्या (30) मिनटां उसरां वता. प्लॅटफॉर्म क्रमांक (1) चेर (19:00) (15) मिनटांचो थारावीक थांबो घेवन (टाटानगर जंक्शन) पावपाची अपेक्षा आसा.",
  ...
  },
  {
    ...
    code: "gu",
    custom:
      "્રેન નંબર (train_no), (દક્ષિણ બિહાર એક્સપ્રેસ), હાલમાં (30) મિનિટ વિલંબિત છે. તે (15) મિનિટના નિર્ધારિત વિરામ સાથે (19:00) પ્લેટફોર્મ નંબર (1) પર (ટાટાનગર જંક્શન) પહોંચવાની અપેક્ષા છે.",
  ...
  },
  {
    ...
    code: "kn",
    custom:
      " ರೈಲು ಸಂಖ್ಯೆ (train_no), (ದಕ್ಷಿಣ ಬಿಹಾರ ಎಕ್ಸ್ಪ್ರೆಸ್), ಪ್ರಸ್ತುತ (30) ನಿಮಿಷಗಳಷ್ಟು ವಿಳಂಬವಾಗಿದೆ. ಇದು (15) ನಿಮಿಷಗಳ ನಿಗದಿತ ನಿಲುಗಡೆಯೊಂದಿಗೆ (19:00) ಪ್ಲಾಟ್ಫಾರ್ಮ್ ಸಂಖ್ಯೆ (1) ನಲ್ಲಿ (ಟಾಟಾನಗರ ಜಂಕ್ಷನ್) ತಲುಪುವ ನಿರೀಕ್ಷೆಯಿದೆ.",
  ...
  },
  {
    ...
    code: "ks",
    custom:
      "ٹرین نمبر (train_no)، (ساؤتھ بہار ایکسپریس)، چھ وٕنکیٚنس (30) منٹ تاخیرس منٛز۔ یہ چھٗ پلیٹ فارم نمبرس (1) پیٹھ (19:00) پیٹھ (15) منٹن ہند مقرر رکنس سٕتہ (ٹاٹا نگر جنکشن) تام واتنٗک امکان۔",
  ...
  },
  {
    ...
    code: "ks_Deva",
    custom:
      "ट्रेन नंबर (train_no), (साउथ बिहार एक्सप्रेस), वर्तमान में (30) मिनट लेट है। इ छी आसा (टाटानगर जंक्शन) प्लेटफार्म नंबर (1) पेठ (19:00) (15) मिनट्स शिड्यूल हाल्ट सेथ",
  ...
  },
  {
    ...
    code: "mai",
    custom:
      "ट्रेन नम्बर (train_no), (दक्षिण बिहार एक्सप्रेस), वर्तमानमे (30) मिनट देरीसँ चलि रहल अछि। एकर प्लेटफॉर्म नंबर (1) पर (19:00) (15) मिनटक निर्धारित विरामक संग (टाटानगर जंक्शन) पहुँचबाक उम्मीद छैक।",
  ...
  },
  {
    ...
    code: "ml",
    custom:
      "ട്രെയിൻ നമ്പർ (train_no), (സൌത്ത് ബീഹാർ എക്സ്പ്രസ്), നിലവിൽ (30) മിനിറ്റ് വൈകുന്നു. പ്ലാറ്റ്ഫോം നമ്പർ (1) ൽ (19:00) (15) മിനിറ്റ് ഷെഡ്യൂൾ ചെയ്ത സ്റ്റോപ്പോടെ ഇത് (ടാറ്റാനഗർ ജംഗ്ഷനിൽ) എത്തുമെന്ന് പ്രതീക്ഷിക്കുന്നു.",
  ...
  },
  {
    ...
    code: "mni_Beng",
    custom:
      "ত্রেন নম্বর (train_no), (সাউথ বিহার এক্সপ্রেস) অসি হৌজিক মিনিৎ 30 হেন্না লেপখ্রে। মসি প্লেতফোর্ম নম্বর (1) দা (19:00) মিনিট 15 লেপতুনা (টাটানগর জঙ্কসন) য়ৌগনি হায়না থাজনরি।",
  ...
  },
  {
    ...
    code: "mr",
    custom:
      "रेल्वे क्रमांक (train_no), (दक्षिण बिहार एक्स्प्रेस), सध्या (30) मिनिटे विलंबित आहे. ती प्लॅटफॉर्म क्रमांक (1) वर (19:00) वर (टाटानगर जंक्शन) येथे (15) मिनिटांच्या नियोजित थांब्याने पोहोचणे अपेक्षित आहे.",
  ...
  },
  {
    ...
    code: "ne",
    custom:
      "्रेन नम्बर (train_no), (दक्षिण बिहार एक्सप्रेस), हाल (30) मिनेट ढिलो भएको छ। यो प्लेटफर्म नम्बर (1) मा (19:00) (15) मिनेटको निर्धारित स्टपको साथ (टाटानगर जङ्सन) मा पुग्ने अपेक्षा गरिएको छ।",
  ...
  },
  {
    ...
    code: "or",
    custom:
      "ଟ୍ରେନ୍ ନମ୍ବର (train_no), (ଦକ୍ଷିଣ ବିହାର ଏକ୍ସପ୍ରେସ୍), ବର୍ତ୍ତମାନ (30) ମିନିଟ୍ ବିଳମ୍ବ ହୋଇଛି। ଏହା ପ୍ଲାଟଫର୍ମ ନମ୍ବର (1) ରେ (19:00) (ଟାଟାନଗର ଜଙ୍କସନ) ରେ (15) ମିନିଟର ନିର୍ଦ୍ଧାରିତ ଷ୍ଟପ୍ ସହିତ ପହଞ୍ଚିବ ବୋଲି ଆଶା କରାଯାଉଛି।",
  ...
  },
  {
    ...
    code: "pa",
    custom:
      "ਟ੍ਰੇਨ ਨੰਬਰ (train_no), (ਦੱਖਣੀ ਬਿਹਾਰ ਐਕਸਪ੍ਰੈਸ), ਇਸ ਵੇਲੇ (30) ਮਿੰਟ ਦੇਰੀ ਨਾਲ ਚੱਲ ਰਹੀ ਹੈ। ਇਸ ਦੇ (15) ਮਿੰਟ ਦੇ ਨਿਰਧਾਰਤ ਰੁਕਣ ਦੇ ਨਾਲ (19:00) ਪਲੇਟਫਾਰਮ ਨੰਬਰ (1) ਉੱਤੇ (ਟਾਟਾਨਗਰ ਜੰਕਸ਼ਨ) ਪਹੁੰਚਣ ਦੀ ਉਮੀਦ ਹੈ।",
  ...
  },
  {
    ...
    code: "sa",
    custom:
      "रेल्-सङ्ख्या (train_no), (दक्षिण-बिहार-एक्स्प्रेस्), सम्प्रति (30) निमेषान् यावत् विलम्बिता अस्ति। प्ल्याट्फ़ार्म्-सङ्ख्यायां (1) इत्यत्र (19:00) (15) निमेषेषु नियत-विरामेन सह (टाटानगर-जङ्क्शन्) आगच्छति इति अपेक्ष्यते।",
  ...
  },
  {
    ...
    code: "sat",
    custom:
      "ᱴᱮᱨᱮᱱ ᱱᱚᱢᱵᱚᱨ (train_no), (ᱫᱚᱠᱷᱤᱱ ᱵᱤᱦᱟᱨ ᱮᱠᱥᱯᱨᱮᱥ), ᱱᱟᱦᱟᱜ (30) ᱴᱤᱲᱤᱡ ᱛᱟᱭᱚᱢ ᱟᱠᱟᱱᱟ ᱾ ᱱᱚᱶᱟ ᱫᱚ (15) ᱴᱤᱲᱤᱡ ᱚᱠᱛᱚ ᱞᱟᱹᱜᱤᱫ ᱵᱚᱱᱚᱫᱚᱞ ᱥᱟᱶᱛᱮ (1) ᱱᱚᱢᱵᱚᱨ (19:00) ᱨᱮ (ᱛᱚᱛᱟᱱᱜᱚᱨ ᱡᱳᱝᱥᱚᱱ) ᱥᱮᱴᱮᱨᱚᱜᱼᱟ ᱢᱮᱱᱛᱮ ᱢᱚᱱᱮ ᱦᱩᱭᱩᱜ ᱠᱟᱱᱟ ᱾",
  ...
  },
  {
    ...
    code: "sd",
    custom:
      "ٽرین نمبر (train_no)، (ڏکڻ بہار ایڪسپریس)، ھن وقت (30) منٽ دیر آھی ان جی (15) منٽن جی مقرر ڪیل اسٽاپ سان پلیٽ فارم نمبر (1) تی (19:00) تی (ٽاٽانگر جنڪشن) تی پھچڻ جی امید آھی",
...

  {
    ...
    code: "sd_Deva",
    custom:
      "ट्रेन जो नम्बरु (train_no), (ॾिखणु बिहार एक्सप्रेस), हिन वक़्त (30) मिनट जी देरी आहे हुन जे प्लेटफार्म नंबर (1) ते (19:00) ते (15) मिनट जे नियत रुकणु सां गडु॒ (टाटानगर जंक्शन) ते पहुचणु जी आस आहे",
  ...
  },
  {
    ...
    code: "ta",
    custom:
      "ரயில் எண் (train_no), (தெற்கு பீகார் எக்ஸ்பிரஸ்), தற்போது (30) நிமிடங்கள் தாமதமாக உள்ளது. இது (15) நிமிடங்கள் திட்டமிடப்பட்ட நிறுத்தத்துடன் (19:00) இயங்குதளம் எண் (1) இல் (டாடாநகர் சந்திப்பு) வரும் என்று எதிர்பார்க்கப்படுகிறது.",
  ...
  },
  {
    ...
    code: "te",
    custom:
      "రైలు సంఖ్య (train_no), (దక్షిణ బీహార్ ఎక్స్ప్రెస్), ప్రస్తుతం (30) నిమిషాలు ఆలస్యంగా నడుస్తోంది. ఇది (15) నిమిషాల నిర్ణీత విరామంతో ప్లాట్ఫాం నంబర్ (1) వద్ద (19:00) (టాటానగర్ జంక్షన్) చేరుకుంటుందని భావిస్తున్నారు.",
